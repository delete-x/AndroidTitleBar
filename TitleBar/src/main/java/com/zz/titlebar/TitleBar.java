...
import com.zz.titlebar.initializers.BaseTitleBarInitializer;
import com.zz.titlebar.initializers.LightTitleBarInitializer;
import com.zz.titlebar.initializers.NightTitleBarInitializer;
import com.zz.titlebar.initializers.RippleTitleBarInitializer;
import com.zz.titlebar.initializers.TransparentTitleBarInitializer;
...
public class TitleBar extends FrameLayout
    ...
    /** 默认初始化器 */
    private static TitleBarInitializer sGlobalInitializer;
    /** 当前初始化器 */
    private final TitleBarInitializer mCurrentInitializer;
    ...
    public TitleBar(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        if (sGlobalInitializer == null) {
            sGlobalInitializer = new LightTitleBarInitializer();
        }
        ...
        switch (array.getInt(R.styleable.TitleBar_barStyle, 0)) {
            case 0x10:
                mCurrentInitializer = new LightTitleBarInitializer();
                break;
            case 0x20:
                mCurrentInitializer = new NightTitleBarInitializer();
                break;
            case 0x30:
                mCurrentInitializer = new TransparentTitleBarInitializer();
                break;
            case 0x40:
                mCurrentInitializer = new RippleTitleBarInitializer();
                break;
            default:
        ...
        if (array.hasValue(R.styleable.TitleBar_leftIcon)) {
            setLeftIcon(BaseTitleBarInitializer.getDrawableResources(getContext(), array.getResourceId(R.styleable.TitleBar_leftIcon, 0)));
        } else {
        ...
        if (array.hasValue(R.styleable.TitleBar_rightIcon)) {
            setRightIcon(BaseTitleBarInitializer.getDrawableResources(getContext(), array.getResourceId(R.styleable.TitleBar_rightIcon, 0)));
        }
        ...
        if (getBackground() == null) {
            BaseTitleBarInitializer.setViewBackground(this, mCurrentInitializer.getBackgroundDrawable(context));
        }
    ...
    public void onLayoutChange(View v, int left, int top, int right, int bottom, int oldLeft, int oldTop, int oldRight, int oldBottom) {
        ...
        mLeftView.setEnabled(BaseTitleBarInitializer.checkContainContent(mLeftView));
        mTitleView.setEnabled(BaseTitleBarInitializer.checkContainContent(mTitleView));
        mRightView.setEnabled(BaseTitleBarInitializer.checkContainContent(mRightView));
    ...
    public TitleBar setLeftIcon(int id) {
        return setLeftIcon(BaseTitleBarInitializer.getDrawableResources(getContext(), id));
    }
    ...
    public TitleBar setRightIcon(int id) {
        return setRightIcon(BaseTitleBarInitializer.getDrawableResources(getContext(), id));
    }
    ...
    public TitleBar setLeftBackground(int id) {
        return setLeftBackground(BaseTitleBarInitializer.getDrawableResources(getContext(), id));
    }

    public TitleBar setLeftBackground(Drawable drawable) {
        BaseTitleBarInitializer.setViewBackground(mLeftView, drawable);
        return this;
    }
    ...
    public TitleBar setRightBackground(int id) {
        return setRightBackground(BaseTitleBarInitializer.getDrawableResources(getContext(), id));
    }

    public TitleBar setRightBackground(Drawable drawable) {
        BaseTitleBarInitializer.setViewBackground(mRightView, drawable);
        return this;
    }
    ...
    public TitleBar setLineDrawable(Drawable drawable) {
        BaseTitleBarInitializer.setViewBackground(mLineView, drawable);
        return this;
    }
    ...
    public TitleBar setTitleGravity(int gravity) {
        ...
        if (((gravity & Gravity.LEFT) != 0 && BaseTitleBarInitializer.checkContainContent(mLeftView)) ||
                ((gravity & Gravity.RIGHT) != 0) && BaseTitleBarInitializer.checkContainContent(mRightView)) {
     ...
     * 获取当前的初始化器
     */
    public TitleBarInitializer getCurrentInitializer() {
     ...
     * 设置默认初始化器
     */
    public static void setDefaultInitializer(TitleBarInitializer initializer) {
