...
public class TitleBarSelectorDrawable extends StateListDrawable {
    public final static class Builder {
        ...
        public TitleBarSelectorDrawable build() {
            TitleBarSelectorDrawable selector = new TitleBarSelectorDrawable();
            if (mPressed != null) {
