...
import com.zz.titlebar.TitleBarInitializer;

public abstract class BaseTitleBarInitializer implements TitleBarInitializer {
    @Override
    ...
    public View getLineView(Context context) {
        ...
        lineView.setLayoutParams(new FrameLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, 2, Gravity.BOTTOM));
        return lineView;
    }
